...
$i=0;
while ($i<strlen($_POST[inputfromtable]))
{
        if ($_POST[inputfromtable][$i]!="_")
                $BP_name=$BP_name."".$_POST[inputfromtable][$i];
        else
        {
        $i=$i+1;
        break;
...
{
        if ($_POST[inputfromtable][$i]!="_")
                $BP_type=$BP_type."".$_POST[inputfromtable][$i];
        else
        {
                $i=$i+1;
                break;
...
{
        if ($_POST[inputfromtable][$i]!="_")
                $glyc_bond=$glyc_bond."".$_POST[inputfromtable][$i];
        else
        {
                $i=$i+1;
                break;
...
while ($i<strlen($_POST[inputfromtable]))
{
        $protonation=$protonation."".$_POST[inputfromtable][$i];
        $i=$i+1;
}
